...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        /// <summary>
        /// Verifica se o CPF de um cliente já foi cadastrado anteriormente
        /// </summary>
        ...
        /// <summary>
        /// Verifica quantidade de CPFs cadastrados
        /// </summary>
        /// <param name="CPF"></param>
        /// <returns></returns>
        internal List<DML.Cliente> VerificarCPFCadastrado(string CPF)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            DataSet ds = base.Consultar("FI_SP_VerificaCliente", parametros);
            List<DML.Cliente> clientes = Converter(ds);
        ...
        /// <summary>
        /// Converte um DataSet para um Lista de Clientes
        /// </summary>
        /// <param name="ds"></param>
        /// <returns></returns>
